...
/// hardware.
pub struct EsbIrq<const OUTGOING_LEN: usize, const INCOMING_LEN: usize, Timer, STATE>
where
    Timer: EsbTimer,
{
...
impl<const OUTGOING_LEN: usize, const INCOMING_LEN: usize, Timer, STATE>
    EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, STATE>
where
    Timer: EsbTimer,
{
    /// Puts the driver in the disabled state
    pub fn into_disabled(mut self) -> EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, Disabled> {
...
impl<const OUTGOING_LEN: usize, const INCOMING_LEN: usize, Timer>
    EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, Disabled>
where
    Timer: EsbTimer,
{
    /// Puts the driver in the PTX mode
    pub fn into_ptx(self) -> EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, StatePTX> {
        EsbIrq {
            prod_to_app: self.prod_to_app,
            cons_from_app: self.cons_from_app,
            timer: self.timer,
    ...
    pub fn into_prx(self) -> EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, StatePRX> {
        EsbIrq {
            prod_to_app: self.prod_to_app,
            cons_from_app: self.cons_from_app,
            timer: self.timer,
...
impl<const OUTGOING_LEN: usize, const INCOMING_LEN: usize, Timer>
    EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, StatePTX>
where
    Timer: EsbTimer,
{
...
impl<const OUTGOING_LEN: usize, const INCOMING_LEN: usize, Timer>
    EsbIrq<OUTGOING_LEN, INCOMING_LEN, Timer, StatePRX>
where
    Timer: EsbTimer,
{
    /// Must be called inside the radio interrupt handler
